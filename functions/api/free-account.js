...
export async function onRequestPost({ env }) {
  ...
  await env.DB.prepare('INSERT INTO accounts (id, session_hash, access_hash, email, credits) VALUES (?, ?, ?, ?, ?)').bind(accountId, sessionHash, accessHash, 'free@aikeji.xin', 999999).run();
